...
@Embeddable
public class JamContestWinnerId implements Serializable {
  ...
  public JamContestWinnerId() {
  }

  public JamContestWinnerId(UUID jamId, UUID userId) {
    this.jamId = jamId;
    this.userId = userId;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof JamContestWinnerId that)) return false;
